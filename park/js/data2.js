				...
				for (var i = 0; i < propertyNames.length; i++) { 
					...
					if(tmp == '"25"'){
						if(status == '"1"'){
							...
							document.getElementById("twentyfive").className = "";
						}
						else if(status == '"10"'){
					...
					if(tmp == '"26"'){
						if(status == '"1"'){
							document.getElementById("twentysix").src="./img/ic_action_26_1.png";
														document.getElementById("twentysix").className = "";
					...
					if(tmp == '"27"'){
						if(status == '"1"'){
							document.getElementById("twentyseven").src="./img/ic_action_27_1.png";
														document.getElementById("twentyseven").className = "";
					...
					if(tmp == '"28"'){
						if(status == '"1"'){
							document.getElementById("twentyeight").src="./img/ic_action_28_1.png";
														document.getElementById("twentyeight").className = "";
					...
					if(tmp == '"29"'){
						if(status == '"1"'){
							document.getElementById("twentynine").src="./img/ic_action_29_1.png";
														document.getElementById("twentynine").className = "";
					...
					if(tmp == '"30"'){
						if(status == '"1"'){
							document.getElementById("thirty").src="./img/ic_action_30_1.png";
														document.getElementById("thirty").className = "";
					...
					if(tmp == '"31"'){
						if(status == '"1"'){
							document.getElementById("thirtyone").src="./img/ic_action_31_1.png";
														document.getElementById("thirtyone").className = "";
					...
					if(tmp == '"32"'){
						if(status == '"1"'){
							document.getElementById("thirtytwo").src="./img/ic_action_32_1.png";
														document.getElementById("thirtytwo").className = "";
					...
					if(tmp == '"33"'){
						if(status == '"1"'){
							document.getElementById("thirtythree").src="./img/ic_action_33_1.png";
														document.getElementById("thirtythree").className = "";
					...
					if(tmp == '"34"'){
						if(status == '"1"'){
							document.getElementById("thirtyfour").src="./img/ic_action_34_1.png";
														document.getElementById("thirtyfour").className = "";
					...
					if(tmp == '"35"'){
						if(status == '"1"'){
							document.getElementById("thirtyfive").src="./img/ic_action_35_1.png";
														...
														document.getElementById("thirtyfive").className = "";
					...
					if(tmp == '"36"'){
						if(status == '"1"'){
							document.getElementById("thirtysix").src="./img/ic_action_36_1.png";
														document.getElementById("thirtysix").className = "";
					...
					if(tmp == '"37"'){
						if(status == '"1"'){
							document.getElementById("thirtyseven").src="./img/ic_action_37_1.png";
														document.getElementById("thirtyseven").className = "";
					...
					if(tmp == '"38"'){
						if(status == '"1"'){
							document.getElementById("thirtyeight").src="./img/ic_action_38_1.png";
														document.getElementById("thirtyeight").className = "";
					...
					if(tmp == '"39"'){
						if(status == '"1"'){
							document.getElementById("thirtynine").src="./img/ic_action_39_1.png";
														document.getElementById("thirtynine").className = "";
					...
					if(tmp == '"40"'){
						if(status == '"1"'){
							document.getElementById("forty").src="./img/ic_action_40_1.png";
														document.getElementById("forty").className = "";
